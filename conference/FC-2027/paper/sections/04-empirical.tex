...
Simplicity on Elements occupies the dominant corner of
Section~\ref{sec:imposs:design_space} (strict-best on \axauth{},
\axrevault{}, \axwdbind{}, \axrecbind{}, and \axintro{}
simultaneously) but is a cross-substrate reference rather than a
Bitcoin proposal. Empirical measurements (Simplicity vault
lifecycle 865\vB{}; per-threat consequences; Coq-verified
semantics) are reported in Appendix~\ref{app:simplicity}. Its role
in the argument is to demonstrate that the dominant corner is
occupiable on some substrate, even while no Bitcoin proposal
