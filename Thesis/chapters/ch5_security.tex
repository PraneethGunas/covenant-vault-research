...
80\% more splits per block due to its smaller \texttt{trigger\_and\_revault}
transaction (162\vB{} vs.\ \opvault{}'s \texttt{start\_withdrawal} at 292\vB{}). This correction matters because CCV (BIP-443) is the active proposal
